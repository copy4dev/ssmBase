 ...
 */
package com.copy4dev.ssmbase.modules.gen.web;
...
import com.copy4dev.ssmbase.modules.gen.service.GenSchemeService;
import com.copy4dev.ssmbase.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.copy4dev.ssmbase.modules");
		}
