...
<body>
	...
	<form:form id="inputForm" modelAttribute="modLog" action="${ctx}/log/modLog/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">记录类型[i,w,e]：</label>
			<div class="controls">
				<form:input path="logType" htmlEscape="false" maxlength="1" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">实体编号：</label>
			<div class="controls">
				<form:input path="entityId" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">业务编号：</label>
			<div class="controls">
				<form:input path="bisId" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="msg" htmlEscape="false" rows="4" maxlength="1000" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
